  ...
  return (
    <div className="container-fluid  bg-white">
      ...
      <div className="row align-items-center  ">
        <div className=" text-start col-12 ms-5 col-md-12 col-lg-6 col-xl-5 mt-5  pb-5">
      ...
      >
        ...
        <div className="col-3  mt-5 ps-0">
          ...
          <ul className="list-group list-group-flush text-start  ps-0 ">
            ...
            <li className="list-group-item border-0 ps-0">On-page SEO Audit</li>
          </ul>
        </div>
      ...
      >
        <div className="col-12 justify-content center align-items-center">
          ...
          <p className="  align-text-center mb-5 mt-4">
            ...
            take a look at this beautiful-crafted and error-free HTML template.
          </p>
        </div>
        <div className="col-md-3">
      ...
      <div className="row pt-5 pb-5">
        <div>
          ...
          <p className="pt-3 ">
            ...
            product presentation, and advertisement running across social media.
          </p>
        </div>
        <div className="row ">
      ...
      <div className="row pt-5 mt-5">
        <div className="col-md-3 col-sm-12 mt-sm-4 text-start">
          ...
          <ul className="list-group list-group-flush ">
            ...
            <li className="list-group-item border-0 padding-0 ">0123456789</li>
            <li className="list-group-item border-0 padding-0 ">
              www.example.com
            </li>
          </ul>
        ...
        <div className="col-md-3 col-sm-12 mt-sm-4 text-start">
          <h2>Who are we ?</h2>
          <ul className="list-group list-group-flush ">
            <li className="list-group-item border-0 padding-0 ">About us ?</li>
            <li className="list-group-item border-0 padding-0 ">
              Before you go ?
            </li>
            <li className="list-group-item border-0 padding-0 ">
        ...
        <div className="col-md-3 col-sm-12 mt-sm-4 text-start">
          <h2>quick links</h2>
          <ul className="list-group list-group-flush ">
            <li className="list-group-item border-0 padding-0 ">our address</li>
            <li className="list-group-item border-0 padding-0 ">
              demo@example
            </li>
            <li className="list-group-item border-0 padding-0 ">0123456789</li>
